...
import NewInSection from "./NewInSection.jsx";
import About from "./About.jsx";
import Hero from "./Hero.jsx";
import FeaturedCollections from "./FeaturedCollections.jsx";
...
const HomePage = () => {
    ...
    const loadAllProducts = async () => {
        try {
            ...
            console.log('Raw API response for all products:', allProducts);
